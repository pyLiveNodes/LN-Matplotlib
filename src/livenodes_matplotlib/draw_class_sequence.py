...
class Ports_in(NamedTuple):
    recognition: Port_Vector = Port_Vector("Recognition")
    annot: Port_Vector_of_Strings = Port_Vector_of_Strings("Annotation")
    hmm_meta: Port_Dict = Port_Dict("HMM Meta")
...
class Draw_class_sequence(View_MPL):
    """
    ...
    def _should_process(self,
        ...
        res = recognition is not None \
            ...
            and (annotation is not None or not self._is_input_connected(self.ports_in.annot))
        # if not res:
